...
Build can be done using:

```
npm run webpack:prod
```

Service root url can be changed in __webpack.prod.js__.
...
To build the final jar and optimize the omniview application for production, run:
